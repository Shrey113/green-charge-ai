...
export default function GridOperatorSidebar({ activeTab = 'dashboard', onTabChange, isCompact = false }) {
  return (
    <aside className={`grid-operator-sidebar ${isCompact ? 'compact' : ''}`}>
      {/* Brand Header */}
      <div className="sidebar-brand">
        <div className="sidebar-brand-icon">
          <svg viewBox="0 0 24 24" width="26" height="26" fill="#10B981">
        ...
        <div className="sidebar-brand-text">
          <h2 className="sidebar-brand-name">GreenCharge AI</h2>
          <span className="sidebar-brand-role">Grid Operator</span>
        </div>
      </div>
      ...
      <div className="sidebar-footer">
        ...
        <p className="footer-slogan-text">
          Clean Energy.<br />
          <strong>Stronger Grids.</strong><br />
          Brighter Tomorrows.
        </p>
      </div>
    </aside>
